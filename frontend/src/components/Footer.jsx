          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <a
                    href="mailto:contato@raphaelpascon.com"
                    className="text-navy-200 hover:text-white transition-colors duration-300"
                  >
                    contato@raphaelpascon.com
                  </a>
                  <p className="text-xs text-navy-300 mt-1">
                    Resposta em até 24h
                  </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              <p className="text-navy-200">
                © {currentYear} Raphael Pascon - Regularização Condominial. 
                Todos os direitos reservados.
              </p>
              <p className="text-sm text-navy-300 mt-1">
                Única empresa da região especializada em regularização de documentações 
