...
const GallerySection = () => {
  ...
  // Imagens exatamente como estão na pasta /public/images/gallery
  const galleryImages = [
    // URBANOS
    {
      id: 1,
      src: "/images/gallery/CONDOMINIO CASAS.jpg",
      alt: "Condomínio urbano com casas - vista aérea",
      category: "urban",
    ...
    {
      id: 5,
      src: "/images/gallery/CONDOMINIO CHACARAS.jpg",
    ...
    },
    {
      ...
      alt: "Chácaras próximas a lago - vista aérea",
      category: "rural",
    ...
    },
    {
      ...
      alt: "Projeto de loteamento com lazer",
      category: "rural",
    ...
    {
      id: 9,
      src: "/images/gallery/CLUBE VISTA AEREA.jpg",
    ...
    {
      id: 10,
      src: "/images/gallery/CLUBE 02 VISTA AEREA.jpg",
  ...
  const categories = useMemo(
    () => [
      ...
      {
        id: "rural",
        name: "Condomínios Rurais",
        count: galleryImages.filter((i) => i.category === "rural").length
      },
      {
        id: "urban",
        name: "Condomínios Urbanos",
        count: galleryImages.filter((i) => i.category === "urban").length
      },
      {
        id: "documentation",
        name: "Documentação",
        count: galleryImages.filter((i) => i.category === "documentation").length
      }
    ],
    [galleryImages]
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Conheça alguns dos nossos projetos de regularização realizados com
            sucesso. Cada projeto representa nossa dedicação em trazer segurança
            jurídica para nossos clientes.
          </p>
        </div>
            ...
            >
              <div className="relative aspect-square overflow-hidden">
                <img
                  ...
                  alt={image.alt}
                  onError={(e) => {
                    // Se algum arquivo faltar, não quebra a página:
                    e.currentTarget.style.opacity = 0.15;
                    e.currentTarget.title = "Arquivo não encontrado";
                  }}
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 italic">
            * As imagens são representativas dos tipos de projetos que
            realizamos. Cada projeto é único e atende às necessidades
